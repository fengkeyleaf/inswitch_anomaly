...
if __name__ == '__main__':
    fp: str = "D:/networking/datasets/anomoaly_detection/BoT-loT/re-formatted/UNSW_2018_IoT_Botnet_Dataset_2_reformatted.csv"
    with open( "./output_sample.json", "r" ) as f_json:
